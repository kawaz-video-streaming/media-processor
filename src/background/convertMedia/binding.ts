...
export const createConvertMediaConsumerBinding = () => createConsumerBinding(CONVERT_MEDIA_CONSUMER_QUEUE, CONVERT_MEDIA_CONSUMER_EXCHANGE, CONVERT_MEDIA_CONSUMER_TOPIC);
